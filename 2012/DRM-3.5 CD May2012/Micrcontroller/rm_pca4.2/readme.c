...
Specifications:
	...
	Count32 Range in log:	log(4e9) - log(4e3)	= 6
 	...
 	Iout = 3*Vout + 1;	in mA
		...
		13-09-2011
		New PCB Design (DC-DC 24 Volt; Power Supply 5V,and 12V, Isolation, AD420)
		
		AD420 Calibration
		dac_val = 65535/999.999*(frequency-0.001)
		Current = 16*dac_val/65535+4
		
		07-02-2011
		New PCB With Power Supply (24V and 5V) and (5V Digital)
		Led's Placement Changed
